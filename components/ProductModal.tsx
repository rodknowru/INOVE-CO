      ...
      {product && (
        ...
        >
          <motion.div
            ...
            className="relative bg-[#F5F0EB] max-w-6xl w-full max-h-[90vh] overflow-y-auto shadow-2xl text-[#3C3228]"
          ...
          >
            ...
            <div className="p-8 md:p-12 lg:p-14 flex flex-col">
              ...
              <div className="mt-8 pt-8 border-t border-[#3C3228]/10 font-sans text-[17px] leading-[1.8] text-[#3C3228] whitespace-pre-line">
                {product.description}
              </div>
            </div>
          </motion.div>
